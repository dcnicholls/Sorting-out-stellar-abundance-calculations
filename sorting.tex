...
\section{Definitions}
The abundance\footnote{in terms or numbers of atoms rather than mass} of oxygen in a stellar spectrum relative to the standard solar abundance is denoted by $[\text{O}]_*$, and the relative or normalised abundance of iron by $[\text{Fe}]_*$, where,
\begin{equation}
