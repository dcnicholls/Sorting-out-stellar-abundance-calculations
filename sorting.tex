...
We may also wish to convert elemental abundances relative to iron (i.e. [O/Fe]) between the two standards. Since these are logarthimic values,
\begin{equation}
...
Expressed as a physically meaningful expression,
\begin{equation}
