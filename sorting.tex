...
\begin{equation}
[\text{O}/\text{Fe}]_{*LGC} = [\text{O}/\text{Fe}]_{*original} + 8.69 - 8.76 - 7.50 + 7.52 = [\text{O}/\text{Fe}]_{*original} -0.05 \ .
\end{equation}
and
\begin{equation}
[\text{Fe}]_{*LGC} = [\text{Fe}]_{*original} + 7.50 - 7.52 = [\text{Fe}]_{*original} - 0.02 \ .
\end{equation}
