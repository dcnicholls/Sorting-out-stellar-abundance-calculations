...
In ultraviolet, visible and infrared nebular spectra, oxygen emission lines are among the strongest, and are easy to measure accurately. Iron emission lines, conversely, are faint in most nebulae.  Oxygen is the third most common element in the Universe after hydrogen and helium and far more abundant than iron. Consequently oxygen is used as the standard scale for nebular abundance. Total metallicity is usually reported in terms of the oxygen abundance, using the ``12'' notation: e.g., 12+log$_{10}$(O/H), or expressed as a ratio to the solar abundance. Carbon and nitrogen abundances are regularly reported in terms of their ratios to oxygen: (log$_{10}$(C/O) and log$_{10}$(N/O)). 
