...
Let us assume we wish to convert the normalised iron abundance [Fe]$_*$ and normalised oxygen to iron ratio [O/H]$_** from standards used by an observer in reporting their results to the local galactic concordance (LGC) standard used by Mappings.  In the LGC, in the 12 +log notation, $\log_{10}(O/H)_\odot$ = 8.76 and $\log_{10}(Fe/H)_\odot$ = 7.52, whence $[\text{O}/\text{Fe}]$ = 1.24 .
