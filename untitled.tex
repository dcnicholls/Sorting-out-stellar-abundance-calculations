...
Eliminting $a_*$ and $b_*$, we may use Equation 8 to derive expressions for the normalised abundances in standard 2 in terms of the normalised abundances in standard 1, as follows,
