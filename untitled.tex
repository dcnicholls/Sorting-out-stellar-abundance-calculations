...
Eliminting $a_*$ and $b_*$, we may use Equation 6 to derive expressions for the normalised abundances in standard 2 in terms of the normalised abundances in standard 1, as follows,
\begin{equation}
x_2 = x_1 + c_1 - c_2 
\end{equation}
and
